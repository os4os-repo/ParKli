...
module.exports = {
    ...
    // lost.
    //credentialSecret: (process.env.NODERED_CREDKEY === 'true'),
    ...
    logging: {
        ...
        console: {
            ...
            level: process.env.NODERED_LOGLEVEL || "info",
            // Whether or not to include metric events in the log output
            metrics: (process.env.NODERED_METRICS === 'true'),
            // Whether or not to include audit events in the log output
            audit: (process.env.NODERED_AUDIT === 'true')
        }
    },
    ...
    editorTheme: {
        projects: {
            ...
            enabled: (process.env.NODERED_PROJECTS === 'true'),
            workflow: {
        ...
        page: {
            title: process.env.NODERED_PAGETITLE || "os4os NodeRed"
        },
        header: {
            title: process.env.NODERED_HEADERTITLE || "os4os NodeRed",
            image: process.env.OS4OS_DIR + "/os4os_logo_small.png"
        },
        login: {
            image: process.env.OS4OS_DIR + "/os4os_logo_medium.png" // a 256x256 image
        }
    }
}
